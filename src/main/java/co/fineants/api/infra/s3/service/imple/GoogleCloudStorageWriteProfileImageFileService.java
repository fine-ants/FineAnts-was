...
public class GoogleCloudStorageWriteProfileImageFileService implements WriteProfileImageFileService {
	private final RemoteFileUploader uploader;
	private final String profilePath;
	private final UuidGenerator uuidGenerator;

	public GoogleCloudStorageWriteProfileImageFileService(RemoteFileUploader uploader, String profilePath,
