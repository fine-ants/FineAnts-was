...
import co.fineants.config.ExchangeRateServiceConfig;
import co.fineants.config.MemberServiceConfig;
import co.fineants.config.StockDividendServiceConfig;
...
@Import(value = {MemberServiceConfig.class, StockDividendServiceConfig.class, ExchangeRateServiceConfig.class})
