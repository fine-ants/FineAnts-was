...
public class FileContentComparator {
	...
	public static void compare(String content, String goldFilePath) {
	...
	private static void compareContent(Reader reader, String goldFilePath) throws IOException {
	...
	public static void compare(InputStream inputStream, String goldFilePath) {
